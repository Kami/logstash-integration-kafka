...
require_jar('io.confluent', 'kafka-avro-serializer', '7.0.1')
require_jar('io.confluent', 'kafka-schema-serializer', '7.0.1')
require_jar('io.confluent', 'common-config', '7.0.1')
require_jar('org.apache.avro', 'avro', '1.11.0')
require_jar('io.confluent', 'kafka-schema-registry-client', '7.0.1')
require_jar('org.apache.kafka', 'kafka_2.12', '2.8.1')
require_jar('io.confluent', 'common-utils', '7.0.1')
